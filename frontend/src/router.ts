...
// プロフィール表示ラベルを変更する関数のインポート
import { changeProfileLabel } from './app';

// ページコンテンツをキャッシュするためのオブジェクト
...
// ページ切り替え時のクリーンアップ関数を保持
let currentCleanup: (() => void) | null = null;

// ページに応じたスクリプトを動的に読み込む関数
